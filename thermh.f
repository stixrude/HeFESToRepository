	subroutine thermh(ispec,Vi,volnl,Cp,Cv,gamma,K,Ks,alp,Ftot,ph,ent,deltas,tcal,
     &               zeta,Gsh,uth,uto,thet,q,etas,dGdT,pzp,Sel,Eel,Pel,Cvel,Eig,Pig,P,E)
	...
	include 'hydrogen.inc'
     ...
     &                   tcal,zeta,Gsh,uth,uto,thet,q,etas,dGdT,pzp,Sel,Eel,Pel,Cvel,Eig,Pig,P,E
        double precision apar,Ti,Pi,volumeh,Fpv
	integer ispec
        integer jlop,klop,jlot,klot,i,j,it,jp
	integer, save :: ncall
        integer, parameter :: mint = 2
        double precision logTi,logPi,y,dy,x1,rho,rhop,rhom
