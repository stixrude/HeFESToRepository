...
C	Replace calls to XERMSG with simple print statements.  2 September, 2018 Lars Stixrude.
...
c     +      'The number of values to be sorted is not positive.', 1, 1)
           print*, 'SLATEC','DSORT','The number of values to be sorted is not positive.', 1, 1
         RETURN
      ENDIF
C
      KK = ABS(KFLAG)
...
c     +      1)
            print*, 'SLATEC','DSORT','The sort control parameter, K, is not 2, 1, -1, or -2.', 2, 1
         RETURN
      ENDIF
C
