        subroutine thermg(ispec,Vi,volnl,Cp,Cv,gamma,K,Ks,alp,Ftot,ph,ent,deltas,
     &                   tcal,zeta,Gsh,uth,uto,thet,q,etas,dGdT,pzp,Sel,Eel,Pel,Cvel,Eig,Pig,P,E)

C  Thermodynamic properties of an ideal gas
	...
	double precision fig,fmth,fn,fxs,Pi,pig,sel,sig,sxs,theta,Ti,to,vo,dfac
        ...
        double precision daktdvel,betael,daktdv
